...
} elseif ($_instance->childHasBeenRendered('LVPjRGn')) {
    $componentId = $_instance->getRenderedChildComponentId('LVPjRGn');
    $componentTag = $_instance->getRenderedChildComponentTagName('LVPjRGn');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('LVPjRGn');
} else {
    $response = \Livewire\Livewire::mount('header-search-component');
    $html = $response->html();
    $_instance->logRenderedChild('LVPjRGn', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('00ebdFT')) {
    $componentId = $_instance->getRenderedChildComponentId('00ebdFT');
    $componentTag = $_instance->getRenderedChildComponentTagName('00ebdFT');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('00ebdFT');
} else {
    $response = \Livewire\Livewire::mount('wishlist-count-component');
    $html = $response->html();
    $_instance->logRenderedChild('00ebdFT', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('tFhrzda')) {
    $componentId = $_instance->getRenderedChildComponentId('tFhrzda');
    $componentTag = $_instance->getRenderedChildComponentTagName('tFhrzda');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('tFhrzda');
} else {
    $response = \Livewire\Livewire::mount('cart-count-component');
    $html = $response->html();
    $_instance->logRenderedChild('tFhrzda', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
