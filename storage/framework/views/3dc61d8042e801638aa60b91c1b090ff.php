...
} elseif ($_instance->childHasBeenRendered('SEtOG06')) {
    $componentId = $_instance->getRenderedChildComponentId('SEtOG06');
    $componentTag = $_instance->getRenderedChildComponentTagName('SEtOG06');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('SEtOG06');
} else {
    $response = \Livewire\Livewire::mount('header-search-component');
    $html = $response->html();
    $_instance->logRenderedChild('SEtOG06', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('T8XLDT8')) {
    $componentId = $_instance->getRenderedChildComponentId('T8XLDT8');
    $componentTag = $_instance->getRenderedChildComponentTagName('T8XLDT8');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('T8XLDT8');
} else {
    $response = \Livewire\Livewire::mount('wishlist-count-component');
    $html = $response->html();
    $_instance->logRenderedChild('T8XLDT8', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('aDHhCyG')) {
    $componentId = $_instance->getRenderedChildComponentId('aDHhCyG');
    $componentTag = $_instance->getRenderedChildComponentTagName('aDHhCyG');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('aDHhCyG');
} else {
    $response = \Livewire\Livewire::mount('cart-count-component');
    $html = $response->html();
    $_instance->logRenderedChild('aDHhCyG', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH C:\xampp\htdocs\PetShop\resources\views/layouts/guest.blade.php ENDPATH**/ ?>