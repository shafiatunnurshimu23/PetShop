...
<head>
	...
	<title>Home</title>	
    <link rel="shortcut icon" type="image/x-icon"  href="asset/woman1.png">
...
} elseif ($_instance->childHasBeenRendered('8cevvrJ')) {
    $componentId = $_instance->getRenderedChildComponentId('8cevvrJ');
    $componentTag = $_instance->getRenderedChildComponentTagName('8cevvrJ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('8cevvrJ');
} else {
    $response = \Livewire\Livewire::mount('header-search-component');
    $html = $response->html();
    $_instance->logRenderedChild('8cevvrJ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('g1aEa2c')) {
    $componentId = $_instance->getRenderedChildComponentId('g1aEa2c');
    $componentTag = $_instance->getRenderedChildComponentTagName('g1aEa2c');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('g1aEa2c');
} else {
    $response = \Livewire\Livewire::mount('wishlist-count-component');
    $html = $response->html();
    $_instance->logRenderedChild('g1aEa2c', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('3nFiaxH')) {
    $componentId = $_instance->getRenderedChildComponentId('3nFiaxH');
    $componentTag = $_instance->getRenderedChildComponentTagName('3nFiaxH');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('3nFiaxH');
} else {
    $response = \Livewire\Livewire::mount('cart-count-component');
    $html = $response->html();
    $_instance->logRenderedChild('3nFiaxH', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
				...
				<!-- <div class="mainbar">
					<ul class="navbarr">
					<li class="menu-item"><a class="link-term mercado-item-title" href="/"><i class="fa fa-home" aria-hidden="true"></i></a>
								</li>
