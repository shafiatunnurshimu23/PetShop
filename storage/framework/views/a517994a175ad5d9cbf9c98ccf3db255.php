        ...
        <div class="wrap-main-slide">
            <div class="slide-carousel owl-carousel style-nav-1" data-items="1" data-loop="1" data-nav="true" data-dots="false">
                <div class="item-slide">
                    <img src="<?php echo e(asset('asset/banner/banner1.webp')); ?>" alt="" class="img-slide">
                </div>
                <div class="item-slide">
                    <img src="<?php echo e(asset('asset/banner/banner2.webp')); ?>" alt="" class="img-slide">
                </div>
                <div class="item-slide">
                    <img src="<?php echo e(asset('asset/banner/banner3.webp')); ?>" alt="" class="img-slide">
                </div>
                <div class="item-slide">
                    <img src="<?php echo e(asset('asset/banner/banner4.webp')); ?>" alt="" class="img-slide">
                </div>
                <div class="item-slide">
                    <img src="<?php echo e(asset('asset/banner/banner5.webp')); ?>" alt="" class="img-slide">
                </div>
            </div>
        </div>
        ...
        <div class="wrap-banner style-twin-default">
            <div class="banner-item">
                <a href="#" class="link-banner banner-effect-1">
                    <figure><img src="<?php echo e(asset('asset/banner/shortBanner1.webp')); ?>" alt="" width="580" height="190"></figure>
                </a>
            </div>
            <div class="banner-item">
                <a href="#" class="link-banner banner-effect-1">
                    <figure><img src="<?php echo e(asset('asset/banner/shortBanner2.webp')); ?>" alt="" width="580" height="190"></figure>
                </a>
            </div>
        </div>
        ...
        <?php if($sproducts->count()>0): ?>
            <div class="wrap-show-advance-info-box style-1 has-countdown">
                ...
                <a href="#" class="link-banner banner-effect-2">
                    <figure><img src="<?php echo e(asset('asset/banner/salebanner.webp')); ?>" width="1170" height="100" alt=""></figure>
                </a>
            </div>
...
<?php /**PATH C:\xampp\htdocs\RoboticsShop\resources\views/livewire/home-component.blade.php ENDPATH**/ ?>