			...
			<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
				...
				<div class="banner-shop">
					<a href="#" class="banner-link">
						<figure><img src="<?php echo e(asset('asset/banner/wide_banner_1')); ?>.jpeg" alt="" style="width:100%; height: 1.5in;"></figure>
					</a>
				</div>
								...
								<div class="product product-style-3 equal-elem ">
									<div class="product-thumnail">
										<a href="<?php echo e(route('product.details', ['slug'=>$product->slug])); ?>" title="<?php echo e($product->name); ?>">
											<figure><img src="<?php echo e(asset('asset/product_image')); ?>/<?php echo e($product->image); ?>" alt="<?php echo e($product->name); ?>"></figure>
										</a>
									</div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/RoboticsShop/resources/views/livewire/category-component.blade.php ENDPATH**/ ?>