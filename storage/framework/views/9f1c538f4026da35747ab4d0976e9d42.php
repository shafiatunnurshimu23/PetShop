...
} elseif ($_instance->childHasBeenRendered('uHT3BuB')) {
    $componentId = $_instance->getRenderedChildComponentId('uHT3BuB');
    $componentTag = $_instance->getRenderedChildComponentTagName('uHT3BuB');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('uHT3BuB');
} else {
    $response = \Livewire\Livewire::mount('header-search-component');
    $html = $response->html();
    $_instance->logRenderedChild('uHT3BuB', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('ceuPmCg')) {
    $componentId = $_instance->getRenderedChildComponentId('ceuPmCg');
    $componentTag = $_instance->getRenderedChildComponentTagName('ceuPmCg');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ceuPmCg');
} else {
    $response = \Livewire\Livewire::mount('wishlist-count-component');
    $html = $response->html();
    $_instance->logRenderedChild('ceuPmCg', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('5As9fH9')) {
    $componentId = $_instance->getRenderedChildComponentId('5As9fH9');
    $componentTag = $_instance->getRenderedChildComponentTagName('5As9fH9');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('5As9fH9');
} else {
    $response = \Livewire\Livewire::mount('cart-count-component');
    $html = $response->html();
    $_instance->logRenderedChild('5As9fH9', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH C:\xampp\htdocs\RoboticsShop\resources\views/layouts/base.blade.php ENDPATH**/ ?>