	...
	<header id="header" class="header header-style-1">
		<div class="container-fluid">
			<div class="row">
				...
				<div class="container">
					<div class="mid-section main-info-area">
						...
						<div class="wrap-logo-top left-section">
							<a href="/" class="link-to-home"><img src="{{asset('asset/petlogo.png')}}" alt="logo"></a>
							</div>
				...
				<div class="mainbar">
					<ul class="navbarr">
					@if(Route::currentRouteName()=='PET.com.bd')
						...
						@if(Route::currentRouteName()=='adopt')
